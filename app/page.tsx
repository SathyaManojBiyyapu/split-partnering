...
const categories: CategoryCard[] = [
  { slug: "gym", label: "Gym", emoji: "🏋️", line: "Split passes & supplements." },
  { slug: "fashion", label: "Fashion", emoji: "👗", line: "Partner on brand offers." },
  { slug: "movies", label: "Movies", emoji: "🎬", line: "Share tickets & combos." },
  { slug: "lenskart", label: "Lenskart", emoji: "👓", line: "Split frames & lenses." },
  { slug: "local-travel", label: "Local Travel", emoji: "🚘", line: "Car / bike / cab splits." },
  { slug: "events", label: "Events", emoji: "🎤", line: "Concerts & show passes." },
  { slug: "coupons", label: "Coupons", emoji: "🎟️", line: "Use your unused deals." },
  { slug: "villas", label: "Villas", emoji: "🏡", line: "Group stays, split bills." },
  { slug: "books", label: "Books", emoji: "📚", line: "Unlock study materials." },
];
    ...
    <main className="min-h-screen text-white relative">
      ...
      <section className="pt-32 pb-24 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          {/* Subline */}
          <p className="text-[#16FF6E]/80 text-sm sm:text-lg max-w-2xl mx-auto mb-6 tracking-wide">
            Partner with strangers for discounts, deals, and many more offers.
          </p>

          {/* Benefits */}
          <div className="max-w-sm mx-auto text-center text-gray-300 text-sm space-y-1 mb-8">
            <p>• Upgrade yourself</p>
            <p>• Save more money</p>
            <p>• Meet random strangers safely</p>
            <p>• Huge offers</p>
            <p>• Discounts everywhere</p>
          </div>
      ...
      {/* HOW IT WORKS */}
      <section id="how-it-works" className="pb-24 px-6 border-t border-[#16FF6E]/10">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-2xl sm:text-3xl font-bold mb-2">
            How SplitPartnering works
          </h2>
          ...
          <div className="grid gap-5 sm:grid-cols-3">
            ...
            <div className="rounded-2xl bg-black/40 border border-[#16FF6E]/30 p-4">
              <p className="text-[#16FF6E] text-sm font-semibold mb-1">1 · Choose</p>
              <p className="text-xs text-gray-300">Login or continue as guest, pick a category and a deal.</p>
            </div>

            <div className="rounded-2xl bg-black/40 border border-[#16FF6E]/30 p-4">
              <p className="text-[#16FF6E] text-sm font-semibold mb-1">2 · Save Partner</p>
              <p className="text-xs text-gray-300">When you hit Save Partner, system creates a matching group.</p>
            </div>

            <div className="rounded-2xl bg-black/40 border border-[#16FF6E]/30 p-4">
              <p className="text-[#16FF6E] text-sm font-semibold mb-1">3 · Get Matched</p>
              <p className="text-xs text-gray-300">When the group fills, admin contacts all members.</p>
            </div>
